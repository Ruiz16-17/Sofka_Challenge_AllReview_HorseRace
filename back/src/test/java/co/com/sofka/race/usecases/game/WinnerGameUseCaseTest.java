...
@SpringBootTest
class WinnerGameUseCaseTest {

    @SpyBean
    WinnerGameUseCase winnerGameUseCase;
    ...
    @Test
    void WinnerGameUseCaseWinCaseTest(){
        ...
        var playerDTO = new PlayerDTO("1","player@Email","namePlayer",1,2L);
        ...
        var resultMono = winnerGameUseCase.apply(gameDTO.getId());
    ...
    @Test
    void WinnerGameUseCaseLoseCaseTest(){
        var gameDTO = new GameDTO("1","1","1",true,2,1L);
        var game = new Game();
